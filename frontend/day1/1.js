window.onload = function () {
    document.querySelector('#parallax_wrapper').addEventListener('mousemove', function (e) {
        ...
        document.querySelector('#parallax_error_text').style.transform = calculateTransform(horizontal, vertical, 50)
        document.querySelector('#parallax_octocat').style.transform = calculateTransform(horizontal, vertical, 10)
        document.querySelector('#parallax_sign').style.transform = calculateTransform(horizontal, vertical, -20)
